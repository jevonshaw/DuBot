...
def main():
    ...
    with col1:
        ...
        if capture_method == "Camera Capture":
            ...
            if camera_image is not None:
                ...
                st.image(resized_face, width='content')
        else:
    ...
    with col2:
        ...
        if uploaded_target is not None:
            ...
            st.image(resized_target, width='content')
        else:
    ...
    with col3:
        ...
        # Face swap button
        if st.button("🔄 Swap Faces", type="primary", width='content'):
        ...
        if st.session_state.swapped_image is not None:
            ...
            st.image(resized_result, width='content')
